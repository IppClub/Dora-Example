...
thread(function() -- 7
	...
	local host = startMobileRemix({ -- 9
		entry = {id = "mobile-remix-preview", title = "轨道花园", workDir = Path:getPath(Path:getPath(Content:getFullPath("Test/Mobile"))), fileName = Content:getFullPath("Test/Mobile/FeedPreviewTest.lua")}, -- 10
