...
D.thread(function()
	...
	local ok, err = xpcall(function()
		...
		press("y"); assert(find(feed,"mobile-project-create-sheet")); focus("mobile-project-create-input")
	...
	D.Content:save("/tmp/dora-gamepad.result",ok and "passed disabledSkip focusRedraw inputActivation back deadzone axisNavigation axisRepeat rightScroll disconnect modalIsolation sameFrameGuard feedCards feedTabs createIME remixIME transcriptScroll modelPanels playIsolation\n" or "failed "..tostring(err))
end)
