...
skip("math", "perlinNoise",
	"Love 12 test API; Love 11.5 exposes the pinned upstream algorithms through love.math.noise")
skip("math", "simplexNoise",
	"Love 12 test API; Love 11.5 exposes the pinned upstream algorithms through love.math.noise")
...
skip("filesystem", "openFile", "Love 12 constructor; Love 11.5 File behavior is covered through newFile")
...
add("image", "CompressedImageData", function()
	...
	equal(data:getMipmapCount(), 2, "CompressedImageData mipmap count")
	...
	equal(data:getSize(), 16, "CompressedImageData byte size")
	local clone = data:clone()
...
skip("physics", "getDistance", "Love 12 fixture-distance helper is not implemented in the Love 11.5 bridge")
...
skipMany("graphics", {
	"newTextBatch", "getStencilMode",
}, "Love 12 test APIs are absent from the fixed Love 11.5 graphics module")
...
add("graphics", "newVideo", function()
	...
	assert(not ok and message:find("no playable audio track", 1, true))
...
skipMany("graphics", {"getTextureFormats"},
	"Love 12 renamed the Love 11.5 getImageFormats API; the embedded target remains Love 11.5")
...
add("graphics", "reset", function()
	...
	equal(love.graphics.getStencilTest(), nil, "reset stencil test")
...
add("graphics", "setStencilTest", function()
	...
	equal(love.graphics.getStencilTest(), nil, "cleared stencil test")
...
add("graphics", "newImage", function()
	local image = love.graphics.newImage("official-image.mock")
...
add("graphics", "newParticleSystem", function()
	local image = love.graphics.newImage("official-particles.mock")
...
add("graphics", "newQuad", function()
	local image = love.graphics.newImage("official-quad.mock")
...
add("graphics", "newSpriteBatch", function()
	local image = love.graphics.newImage("official-batch.mock")
