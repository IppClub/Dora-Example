...
ui:onButtonDown(function(id, buttonName) -- 358
	...
	repeat -- 359
		local ____switch44 = buttonName -- 359
		local ____cond44 = ____switch44 == "dpleft" -- 359
		if ____cond44 then -- 359
			updatePlayerControl("keyLeft", true, true) -- 361
			break -- 361
		end -- 361
		____cond44 = ____cond44 or ____switch44 == "dpright" -- 361
		if ____cond44 then -- 361
			updatePlayerControl("keyRight", true, true) -- 362
			break -- 362
		end -- 362
		____cond44 = ____cond44 or ____switch44 == "b" -- 362
		if ____cond44 then -- 362
...
ui:onButtonUp(function(id, buttonName) -- 366
	...
	repeat -- 367
		local ____switch47 = buttonName -- 367
		local ____cond47 = ____switch47 == "dpleft" -- 367
		if ____cond47 then -- 367
			updatePlayerControl("keyLeft", false, true) -- 369
			break -- 369
		end -- 369
		____cond47 = ____cond47 or ____switch47 == "dpright" -- 369
		if ____cond47 then -- 369
			updatePlayerControl("keyRight", false, true) -- 370
			break -- 370
		end -- 370
		____cond47 = ____cond47 or ____switch47 == "b" -- 370
		if ____cond47 then -- 370
