...
local spineStr = "Spine/dragon-ess" -- 4
local animations = Spine:getAnimations(spineStr) -- 6
local looks = Spine:getLooks(spineStr) -- 7
...
local spine -- 11
do -- 11
	local _with_0 = Spine(spineStr) -- 11
