...
local sprite -- 5
do -- 5
	local _with_0 = Sprite("Image/logo.png") -- 5
	_with_0.scaleX = 0.5 -- 6
	_with_0.scaleY = 0.5 -- 6
	_with_0.showDebug = true -- 7
	sprite = _with_0 -- 5
end -- 5
do -- 9
	local _with_0 = Node() -- 9
	_with_0:onTapMoved(function(touch) -- 10
		if not touch.first then -- 11
			return -- 11
		end -- 11
		sprite.position = sprite.position + touch.delta -- 12
	end) -- 10
