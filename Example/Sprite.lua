...
local sprite -- 4
do -- 4
	local _with_0 = Sprite("Image/logo.png") -- 4
	_with_0.scaleX = 0.5 -- 5
	_with_0.scaleY = 0.5 -- 5
	_with_0.showDebug = true -- 6
	sprite = _with_0 -- 4
end -- 4
do -- 8
	local _with_0 = Node() -- 8
	_with_0:onTapMoved(function(touch) -- 9
